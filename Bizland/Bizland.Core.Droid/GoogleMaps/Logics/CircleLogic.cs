...
{
    public class CircleLogic : DefaultCircleLogic<NativeCircle, Android.Gms.Maps.GoogleMap>
    {
        ...
        private void OnCircleClick(object sender, Android.Gms.Maps.GoogleMap.CircleClickEventArgs e)
        {
            // clicked circle
