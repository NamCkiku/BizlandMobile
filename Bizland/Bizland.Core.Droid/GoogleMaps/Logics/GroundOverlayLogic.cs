...
using Bizland.Core.Droid.Factories;
...
{
    internal class GroundOverlayLogic : DefaultGroundOverlayLogic<NativeGroundOverlay, Android.Gms.Maps.GoogleMap>
    {
        ...
        private void OnGroundOverlayClick(object sender, Android.Gms.Maps.GoogleMap.GroundOverlayClickEventArgs e)
        {
