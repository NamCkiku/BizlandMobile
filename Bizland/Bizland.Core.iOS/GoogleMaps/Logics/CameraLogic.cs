...
namespace Bizland.Core.iOS.Logics
{
    public sealed class CameraLogic : BaseCameraLogic<MapView>
    {
        ...
        private void NativeMap_WillMove(object sender, GMSWillMoveEventArgs e)
        {
        ...
        private void NativeMap_CameraPositionIdle(object sender, GMSCameraEventArgs e)
        {
