...
namespace Bizland.Utilities.Constant
{
    /// <summary>
            ...
            get
            {
                switch (ServerTypes)
                {
                    ...
                    case ServerTypes.ServerThat:
                        return DNSHelper.GetIPAddressServer(ServerTypes.ServerThat.ToDescription(), PortSignalRTypes.ServerThat.ToDescription());
                    ...
                    case ServerTypes.ServerVMS:
                        return DNSHelper.GetIPAddressServer(ServerTypes.ServerVMS.ToDescription(), PortSignalRTypes.ServerVMS.ToDescription());
